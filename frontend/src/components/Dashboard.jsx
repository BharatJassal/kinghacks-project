...
import AiDeepfakeAnalyze from "./AiDeepfakeAnalyze";
...
function Dashboard() {
  ...
  const handleAiUpdate = useCallback((s) => {
    setAiSignals((prev) => ({ ...prev, ...s }));
  }, []);

  useEffect(() => {
    console.log("AI signals:", aiSignals);
  }, [aiSignals]);
    ...
    <div className="dashboard">
      ...
      <div className="dashboard-grid">
        ...
        <section className="feed-section">
          ...
          {stream && (
            <AiDeepfakeAnalyze stream={stream} onUpdate={handleAiUpdate} />
          )}
        </section>
        ...
        <section className="signal-section">
          ...
          <DeviceInspect stream={stream} onSignalsUpdate={setDeviceSignals} />
        </section>

        {/* Frame timing analysis */}
        <section className="signal-section">
          <h2>Frame Timing</h2>
          <FrameTiming stream={stream} onSignalsUpdate={setTimingSignals} />
        </section>
        ...
        <section className="signal-section">
          ...
          <EnvironmentAnalyze onSignalsUpdate={setEnvironmentSignals} />
        </section>
      ...
      <footer className="dashboard-footer">
        <p>
          🔒 All video processing happens client-side • No raw video transmitted
        </p>
      </footer>
    </div>
  );
